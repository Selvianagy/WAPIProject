        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    CustomerApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_shoppingCarts", x => x.ShoppingCartId);
                    table.ForeignKey(
                        name: "FK_shoppingCarts_Customers_CustomerApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    UserId = table.Column<int>(type: "int", nullable: false),
                    IsDeleted = table.Column<bool>(type: "bit", nullable: false),
                    UserApplicationUserId = table.Column<string>(type: "nvarchar(450)", nullable: true)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_Wishlists", x => x.WishlistId);
                    table.ForeignKey(
                        name: "FK_Wishlists_Customers_UserApplicationUserId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Orders_Customers_CustomerApplicationUserId",
                        column: x => x.CustomerApplicationUserId,
                        principalTable: "Customers",
                        principalColumn: "ApplicationUserId");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Orders_CustomerApplicationUserId",
                table: "Orders",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_shoppingCarts_CustomerApplicationUserId",
                table: "shoppingCarts",
                column: "CustomerApplicationUserId");
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Wishlists_UserApplicationUserId",
                table: "Wishlists",
